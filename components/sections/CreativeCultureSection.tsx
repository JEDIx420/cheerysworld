...
export function CreativeCultureSection() {
  return (
    <section className="py-24 md:py-32 bg-stone-950 text-stone-100 relative overflow-hidden border-b border-stone-800">
      ...
      <div className="absolute top-1/2 -translate-y-1/2 -right-20 w-80 h-80 rounded-full bg-purple-600/10 blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <p className="mt-8 text-xl sm:text-2xl md:text-3xl font-serif italic text-stone-300 max-w-2xl mx-auto">
            &ldquo;Five ventures. One creative spirit.&rdquo;
          </p>

          <p className="mt-6 text-stone-400 text-base sm:text-lg max-w-xl mx-auto leading-relaxed">
            Cheerys is a living culture built around the things that matter most: imagination, fine painting, learning, personal expression and well-being.
          </p>
          ...
          <div className="mt-12 flex flex-wrap justify-center gap-3 font-mono text-xs sm:text-sm">
            ...
            <span className="px-4 py-2 rounded-full bg-purple-500/10 border border-purple-500/30 text-purple-300">
              02 cheerys_art
            </span>
